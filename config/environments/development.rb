...
Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { host: "65.60.136.181", port: 3000 }
  ...
  # Enable DNS rebinding protection and other `Host` header attacks.
   config.hosts = [
     "shavetheonion.com",     # Allow requests from example.com
     /.*\.shavetheonion\.com/ # Allow requests from subdomains like `www.example.com`
   ]

  config.hosts << "www.shavetheonion.com "
